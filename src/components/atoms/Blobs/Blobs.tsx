...
export const Blobs = () => {
  return (
    <div className="absolute flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-[32vw] h-[56vh]">
      <div className="absolute w-[32vw] h-[56vh] animate-movement animate-transform bg-twilight" />
