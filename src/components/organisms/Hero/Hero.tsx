...
export const Hero = () => {
  ...
  return (
    <div className="z-20 flex flex-col items-center justify-center h-full px-4 overflow-hidden text-center lg:py-16 md:items-end md:text-right md:px-8 lg:px-20 bg-midnight">
      <Blobs />
